...
public class Rememberme {
    ...
    private static final String PREF_NAME = "rememberme";
    ...
    private static final String IS_REMEMBER = "IsRemembered";
    ...
    public  String getKeyUserPassword(){
        return pref.getString(KEY_USER_PASSWORD,default_string);
    }
