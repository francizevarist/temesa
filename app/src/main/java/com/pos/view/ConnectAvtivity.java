...
import com.pos.utils.SharedXmlUtil;
...
public class ConnectAvtivity extends AppCompatActivity {
    public int state;
    public Button con;
    ...
    public void connect() {
        ...
        if (mBconnect) {
            ...
            if (state > 0) {
                Toast.makeText(ConnectAvtivity.this, "Connected",
                ...
                Toast.makeText(ConnectAvtivity.this, "Fail to Connect",
                        Toast.LENGTH_SHORT).show();
                mBconnect = false;
            }
        }
